...
# print(authenticate(username='jean', password='toto'))
...
class PostTestCase(TestCase):
    ...
    def test_how_long_multiple_days_limit(self):
        ...
        with mock.patch('hnews.posts.models.timezone') as dt:
            dt.now = mock.Mock()
            dt.now.return_value = creation + \
                timedelta(days=20, hours=23, minutes=59, seconds=59)
            self.assertEqual(post.how_long_ago(), '20 days ago')
    ...
    def test_domain_name(self):
        post = Post(
            url='https://techcrunch.com/2018/06/05/washington-sues-facebook-and-google-over-failure-to-disclose-political-ad-spending/')
    ...
    def test_domain_name_with_www(self):
        post = Post(
            url='https://www.livescience.com/61627-ancient-virus-brain.html')
